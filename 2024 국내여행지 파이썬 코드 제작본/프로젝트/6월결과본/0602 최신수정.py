...
# 수작업 코딩된 관광지 데이터 (시/도 및 시군구 단위) - 확장 버전
tourist_spots = {
    # 경기도 하위 지역 (기존 데이터 유지)
    ...
    # 광주광역시 하위 지역
    "2917000000": ["무등산", "국립광주박물관"],
    "2920000000": ["광주광역시립미술관", "518민주묘지"],
    "2953000000": ["양림동 역사문화마을", "광주예술의거리"],
    
    # 대전광역시 하위 지역
    "3017000000": ["엑스포과학공원", "대전오월드"],
    "3020000000": ["유성온천", "계족산"],
    "3023000000": ["대청호", "보문산"],
    
    # 울산광역시 하위 지역
    "3117000000": ["간절곶", "대왕암공원"],
    "3120000000": ["태화강국가정원", "울산대공원"],
    "3171000000": ["울산바위", "신불산"],
    
    # 세종특별자치시 하위 지역
    "3611000000": ["세종호수공원", "국립세종도서관"],
    
    # 강원도 하위 지역
    "4211000000": ["남이섬", "강촌레일파크"],
    "4213000000": ["설악산", "속초해수욕장"],
    "4215000000": ["정동진", "강릉커피거리"],
    "4217000000": ["양양서피비치", "낙산사"],
    "4219000000": ["평창알펜시아", "대관령스키장"],
    "4221000000": ["철원DMZ", "고석정"],
    "4223000000": ["화천산나물축제", "파로호"],
    
    # 충청북도 하위 지역
    "4311000000": ["청주상당산성", "청주공예비엔날레"],
    "4313000000": ["수안보온천", "충주호"],
    "4315000000": ["단양팔경", "도담삼봉"],
    "4372000000": ["보은속리산", "법주사"],
    "4374000000": ["옥천레일바이크", "이화사"],
    
    # 충청남도 하위 지역
    "4413000000": ["아산스파비스", "온양온천"],
    "4415000000": ["공주공산성", "무령왕릉"],
    "4418000000": ["부여낙화암", "백제문화단지"],
    "4420000000": ["서산해미읍성", "간월암"],
    "4421000000": ["태안안면도", "꽃지해변"],
    "4471000000": ["예산수덕사", "삽교천"],
    
    # 전라북도 하위 지역
    "4511000000": ["전주한옥마을", "경기전"],
    "4513000000": ["군산근대역사박물관", "군산철새도래지"],
    "4514000000": ["익산미륵사지", "익산타워"],
    "4518000000": ["정읍내장산", "내장산국립공원"],
    "4519000000": ["남원광한루원", "지리산"],
    "4571000000": ["순창장류박물관", "순창메밀꽃축제"],
    
    # 전라남도 하위 지역
    "4611000000": ["목포해상케이블카", "목포근대역사관"],
    "4613000000": ["여수엑스포", "오동도"],
    "4615000000": ["순천만습지", "순천드라마촬영장"],
    "4617000000": ["보성녹차밭", "대한다원"],
    "4623000000": ["해남대둔산", "코스모스공원"],
    "4671000000": ["담양메타세쿼이아길", "담양대나무밭"],
    "4672000000": ["화순세량제", "화순스파랜드"],
    
    # 경상북도 하위 지역
    "4711000000": ["경주불국사", "경주월정교"],
    "4713000000": ["포항호미곶", "영일대해수욕장"],
    "4715000000": ["김천직지사", "김천프로방스마을"],
    "4717000000": ["안동하회마을", "봉정사"],
    "4719000000": ["구미금오산", "인동도장길"],
    "4721000000": ["영주부석사", "소백산"],
    "4723000000": ["문경새재", "문경석탄박물관"],
    "4725000000": ["예천콘도미니엄", "예천금당실솔밭"],
    "4728000000": ["청도운문사", "청도반시축제"],
    
    # 경상남도 하위 지역
    "4812000000": ["창원마산합포구", "진해군항제"],
    "4817000000": ["진주진주성", "진주남강유등축제"],
    "4822000000": ["통영산림문화수련원", "통영한산도"],
    "4824000000": ["사천바다케이블카", "사천공룡박물관"],
    "4825000000": ["김해김해가야테마파크", "김해수로왕릉"],
    "4827000000": ["밀양영남루", "밀양아리랑박물관"],
    "4831000000": ["거제바람의언덕", "거제외도보타니아"],
    "4833000000": ["남해상주해수욕장", "남해독일마을"],
    "4872000000": ["함양상림공원", "함양메밀꽃축제"],
    "4873000000": ["거창월성계곡", "거창대성동계곡"],
    
    # 대구광역시 하위 지역
    "2711000000": ["대구약령시", "대구근대골목"],
    "2714000000": ["동화사", "팔공산"],
    "2717000000": ["수성못", "수성알파시티"],
    "2720000000": ["앞산공원", "대구스타디움"],
    "2723000000": ["이월드", "두류공원"],
    "2771000000": ["대구삼성라이온즈파크", "대구과학관"]
}
